...
class agent:
    ...
    def __init__(self,parentMaze,x=None,y=None,cost=None,shape='square',goal=None,filled=False,footprints=False,color:COLOR=COLOR.blue):
        ...
        if(hasattr(self,'_head')):
            if self.footprints is False:
                ...
                if self.shape=='square':
                    ...
                    self._parentMaze._canvas.itemconfig(self._head, fill='')#,outline='gray70')
                    self._parentMaze._canvas.tag_raise(self._head)
                    try:
                        self._parentMaze._canvas.tag_lower(self._head,'ov')
                    except:
            ...
            if not self.filled or self.shape=='arrow':
                if self.shape=='square':
                    self._head=self._parentMaze._canvas.create_text(*self._coord2, text=self.cost , fill='#fff',   font=('Helvetica 15 bold'))
                    try:
                        self._parentMaze._canvas.tag_lower(self._head,'ov')
                    except:
                        pass
                else:
                    self._head=self._parentMaze._canvas.create_line(*self._coord,fill='',arrow=FIRST,arrowshape=(3/10*w,4/10*w,4/10*w))#,outline=self.color.name)
                    try:
                        self._parentMaze._canvas.tag_lower(self._head,'ov')
                    except:
                        pass
                ...
                self._head=self._parentMaze._canvas.create_rectangle(*self._coord,fill='',outline='red')#stipple='gray75'
                try:
                    self._parentMaze._canvas.tag_lower(self._head,'ov')
                except:
                        pass
            ...
            self._head=self._parentMaze._canvas.create_rectangle(*self._coord,fill='',outline='')#stipple='gray75'
            try:
                self._parentMaze._canvas.tag_lower(self._head,'ov')
            except:
                pass
...
class maze:
    ...
    def CreateMaze(self,x=randint(1,6),y=randint(1,6),pattern=None,loopPercent=0,saveMaze=False,loadMaze=None,theme:COLOR=COLOR.dark):
